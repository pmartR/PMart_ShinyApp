download_UI <- function() {
  tabPanel("Download",
    ...
    bsCollapse(
                 ...
                 bsCollapsePanel(
                   ...
                   div(
                     ...
                     div(
                       ...
                       div(
                         id = "download_apply_save_options_tooltip", 
                         class = "tooltip-wrapper",
                         actionButton("download_apply_save_options", "Apply")),
                       conditionalPanel(
                         "input.download_file_type!='HTML Widget'", 
                         actionButton("download_preview_image", "Preview"))
                       ),
                     br(),
                     br(),
                     div(
                       style="overflow:auto", 
                       uiOutput("download_image_preview"))
                     ))
      ...
      div(
        style = "float:left",
        bsButton("mark_plot_download", 
                 "Select/de-select for download", 
                 icon = icon("minus")),
        bsButton("remove_plot_download", 
    ...
    div(
      ...
      style = "float:left", 
      class = "grey_button", 
      bsButton("makezipfile", 
               label = tags$b("Bundle up all selected items"), 
               icon = icon("briefcase"), 
               lib = "glyphicon")),
    div(id = "js_downloadbutton", 
        style = "margin-left:4px;float:left", 
        class = "grey_button", 
        downloadButton("download_processed_data", 
