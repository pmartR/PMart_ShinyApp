...
ttext_ <- list(
  ...
  IMDANOVA_NONE_FILTERED = "The chosen minimum values for the iMd-ANOVA filter do not remove any biomolecules, please revise.",
  IMDANOVA_NONSINGLETON_MISSING = "Your data does not contain enough groups with more than one sample: %s.  Minimum g-test must be >= 3.  Minimum ANOVA must be >=2",
