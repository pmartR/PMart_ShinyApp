...
rootdir <- "/Users/degn400/Desktop/Git_Repos/pmart_standalone/Markdowns/proData/ProteinDataInput//"
proData <- readRDS(file.path(rootdir, "proData_protein.RDS"))
proDataAttr <- attributes(proData)
proStats <- readRDS(file.path(rootdir, "proStats_protein.RDS"))
proStatsAttr <- attributes(proStats)
pmart_inputs <- readRDS(file.path(rootdir, "pmart_inputs_protein.RDS"))
spans_results <- readRDS(file.path(rootdir, "spans_res_protein.RDS"))
