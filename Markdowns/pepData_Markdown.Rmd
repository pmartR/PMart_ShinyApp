...
Could not get SPANS to run without error. Error in makePSOCKcluster(names = spec, ...) : 
  Cluster setup failed. 8 of 8 workers failed to connect.

## Protein Rollup

Could not get Protein Rollup to run without error. Error in makePSOCKcluster(names = spec, ...): 
  Cluster setup failed. 7 of 7 workers failed to connect.

## Analysis

```{r Analysis}
data.table("Attribute" = c("Test Method", "Multiple Comparison Adjustment", "Significance Threshold"),
           "Value" = c(pepStatsAttr$statistical_test, pepStatsAttr$adjustment_method,
