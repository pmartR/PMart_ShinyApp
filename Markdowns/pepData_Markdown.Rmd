...
`r ifelse(pmart_inputs$transform == "Select one", ".", paste0("and was transformed to <B>", ifelse(pmart_inputs$transform == "abundance", "raw intensity", pmart_inputs$transform), "</B>"))`. The value to denote 
missing data was **"`r pmart_inputs$na_symbol`"** and the expression data
...
```{r Upload Data: Biomolecule Information}
...
This metadata file **`r ifelse(pmart_inputs$proteins_yn == "FALSE", "does not", "does")`**
contain peptide to protein mappings. 
