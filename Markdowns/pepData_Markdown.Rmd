...
pepData <- readRDS(file.path(rootdir, "pepData_filters.RDS"))
...
SPANS normalization **`r ifelse(is.null(pepDataAttr$data_info$norm_info$norm_type) == FALSE && pepDataAtrr$data_info$norm_info$norm_type == "spans", "was", "was not")`**
used to normalize the data.
