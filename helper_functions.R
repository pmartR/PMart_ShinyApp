...
#   p <- plot(norm_object, color_by = "Group", order_by = "Group"#, interactive = T
#             ) #### Remove legend on left plot when combined
#   p <- capture.output(plot(norm_object, color_by = "Group", order_by = "Group"))
