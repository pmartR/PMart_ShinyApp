...
if (is.null(spans_results) == FALSE) {
  plot(spans_results) # ToFIX - where are SPANS results being saved now? Thanks 
}
``` 
...
```{r Peptide Statistics: Table and Plot, echo = FALSE}
if (is.null(omicStatsRoll) == FALSE) {
...
if (is.null(omicStats) == FALSE) {
  ...
  # Write the code 
  pepStat_code <- paste0('imd_anova(omicObj, test_method = "', omicStatsAttr$statistical_test,
