...
omicDiag <- params$omicDiag # The omic diagnotics for stats
...
`r if (!is.null(omicDataAttr$cnames$emeta_cname)) {paste0("### *Biomolecule Information*\nAn associated biomolecule information file was also uploaded called **", pmart_inputs$file_emeta$name, "** and the molecule identifier column was designated as **", omicDataAttr$cnames$emeta_cname, "**. The file contains ", length(omicData$e_meta) - 1, " column(s) of biomolecule information.")}`
...
if (!is.null(omicStats)) {
  ComparisonsText <- paste0(
    ...
    "followed by a trend diagnotic plot, then the number of siginificant",
...
`r if (!is.null(omicStats)) {"#### Diagnotic Plot \n\n"}`
