...
if (!isTruthy(Sys.which("python"))) {
	...
	fileConn <- file("cfg/local_install.yml")
	writeLines(c("# Local Install Configuration (generated by local_install.R)",
				 "",
				 "python_venv: ./venv",
				 ""),
				 fileConn)
	...
	if (!isTruthy(grep("Sys\\.setenv\\(MAP_CONFIG", readLines("./.RProfile"), value=TRUE))) {
		cat("Sys.setenv(MAP_CONFIG = './cfg/local_install.yml')\n", file="./.RProfile", append=TRUE)
	}
	
	Sys.setenv(MAP_CONFIG = "./cfg/local_install.yml")
	cat("\n")
