...
`r if ("rMD Filter" %in% FilterTable$Filter) {paste0("### *rMD Filter*\nA robust Mahalanobis distance (rMD) filter was applied to the data, removing sample(s), **", metabDataAttr$cnames$fdata_cname, "(s)**, with an associated rMD p-value of less than thre threshold (P-Value Threshold). Metrcis used to calculate the p-values are also included (Metrics Used).")}`
